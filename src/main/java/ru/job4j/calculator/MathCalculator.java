...
public class MathCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + differenceAndDivision(10, 0));
        System.out.println("Результат расчета равен: " + sumAndMultiplyAndDifferenceAndDivision(10, 0));
    }
